...
from trainers.xception_trainer import XceptionModelTrainer
...
def main():
    ...
    trainer = XceptionModelTrainer(model.model, data_loader.train_generator, data_loader.val_generator , config)
